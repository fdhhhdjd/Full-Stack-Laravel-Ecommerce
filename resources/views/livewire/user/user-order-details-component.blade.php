                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('user.orders') }}" class="btn btn-success pull-right">All Orders
                                </a>
                                @if ($order->status == 'ordered')
                                    <a href="#" wire:click.prevent="canceledOrder"
                                        class="btn btn-warning pull-right" style="margin-right: 10px">Canceled</>
                                    </a>
                                @endif
                            </div>
                        </div>
